...
class WeatherViewModelTest {
    ...
    private val viewModel = WeatherViewModel(mockWeatherUseCase, mockAirQualityUseCase)

    @Test
    fun `fetchWeather should update Weather state to Success`(): Unit = runTest {
        // Given
        ...
        // Then
        viewModel.weatherState.test { assertEquals(WeatherState.Success(fakeWeather), awaitItem()) }
    }

    @Test
    fun `fetchAirQuality should update airQuality state to Success`(): Unit = runTest {
        // Given
